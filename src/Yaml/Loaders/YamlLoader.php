...
// +----------------------------------------------------------------------
namespace Zs\Foundation\Yaml\Loaders;

use Zs\Foundation\Yaml\Exceptions\ImmutableException;
use Zs\Foundation\Yaml\Exceptions\InvalidFileException;
...
class YamlLoader
{
     ...
     *
     * @throws \Zs\Foundation\Yaml\Exceptions\ImmutableException
     *
     * @param string      $name
     ...
     *
     * @throws \Zs\Foundation\Yaml\Exceptions\InvalidPathException
     */
     ...
     *
     * @throws \Zs\Foundation\Yaml\Exceptions\InvalidFileException
     */
